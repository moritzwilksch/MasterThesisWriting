...
The most commonly applied ML models for SA are Support Vector Machines, Na\"ive Bayes classifiers, tree-based models, and logistic regression \shortcite{ravi2015survey}. In the domain of financial social media, such ML models are most often applied to posts on StockTwits, a social network to discuss stock-based investments. The platform provides users with the ability to tag posts as bullish or bearish, which aproximately 17\% of them do \shortcite{li2017learning}.
