...
It is noteworthy that while there is plenty of literature on the application of ML models to the task of SA, most of the models are developed using generic data sets like reviews or social media posts and are not published as usable artifacts. While many dictionary-based models as well as deep learning models are available to researchers in the form of downloadable models or programming libraries,
