...
Table \ref{table-classification-report} presents these per-class metrics for the out-of-sample predictions. The model is equally precise for all classes which implies that the probability of any prediction being correct is around $0.64$ across classes.
